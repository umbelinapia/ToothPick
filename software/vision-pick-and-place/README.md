...
- **Final:** [`final/FINALCODEMAX.py`](final/FINALCODEMAX.py) — pulls a frame
  from the camera over HTTP, runs OpenCV Hough Circle detection to find the
  disc, maps its pixel position to robot coordinates, and drives the arm
  ([`../../firmware/arm-controller/final/FINALONE.ino`](../../firmware/arm-controller/final/FINALONE.ino))
...
[`final/FINALCODEMAX.py`](final/FINALCODEMAX.py)).
