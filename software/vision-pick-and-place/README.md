...
- `01` to `03`: basic HTTP capture from the ESP32 camera
- `04` to `07`: first circle/blob detection experiments
- `08`: scratch/draft file
- `09` to `10`: vision detection wrapped in a repeatable loop
- `11` to `12`: vision loop wired up to serial commands to the arm
