...
coordinates. See [`hough-circles-detection-output.png`](../photos/hough-circles-detection-output.png)
for a real detection result, and [`vision-test-captures/`](../photos/vision-test-captures)
