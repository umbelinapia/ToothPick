...
- [`photos/`](photos): [`build-and-dev/`](photos/build-and-dev) (assembly,
  ...
  (raw camera captures used to tune disc detection), [`setup/`](photos/setup)
  (general camera/workspace setup shots), plus the detection output image and
  standalone build photos.
- [`videos/`](videos): a full pick, flip, place cycle demo.
